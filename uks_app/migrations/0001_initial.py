# Generated by Django 3.0.2 on 2020-08-09 15:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='uks_app.User')),
            ],
        ),
        migrations.CreateModel(
            name='Issue',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('event_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='uks_app.Event')),
                ('responsible', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='uks_app.User')),
            ],
            bases=('uks_app.event',),
        ),
        migrations.CreateModel(
